    ...
    <div className="h-[40rem] w-full rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
      ...
      <div className="p-4 max-w-7xl mx-auto relative z-10 w-full pt-20 md:pt-0">
        <h1 className="text-4xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
          {typedGreeting} <br /> I am <a href="https://linktr.ee/keshavgarg24">KESHAV GARG</a>
        </h1>
        <p className="mt-4 font-normal text-base text-neutral-300 max-w-lg text-center mx-auto">
          Software developer from India, enthusiastic about web development and data science.
          <br /> Trying to do new things and become better everyday.
        </p>
        ...
        <div className="flex justify-center mt-4">
          <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
            ...
            <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 ">
              <a
                href="https://drive.google.com/file/d/1NgDF6O55r5F7sJtpuhr6dd3Mmc4sATll/view?usp=share_link"
                target="_blank"
              >
